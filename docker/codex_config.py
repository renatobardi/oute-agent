...
Uso: codex_config.py <config.toml> <environment>
...
out.add(tomlkit.comment("sandbox_mode e [otel]: gerenciados pelo entrypoint do oute-agent. Demais seções: ai-memory / usuário."))
